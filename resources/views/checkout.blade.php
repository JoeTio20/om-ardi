      ...
      <div>
        ...
        <div class="mb-5">
          ...
          <input type="text" name="whatsapp" value="{{ old('whatsapp') }}" placeholder="+62 812..."
            class="w-full border-b border-gray-200 pb-2 text-sm text-gray-800 bg-transparent outline-none placeholder-gray-300">
        </div>

        <div class="grid grid-cols-2 gap-5 mb-5">
          <div>
            <label class="block text-[11px] tracking-widests uppercase text-gray-400 mb-2">First Name</label>
            <input type="text" name="first_name" value="{{ old('first_name') }}" required
              class="w-full border-b border-gray-200 pb-2 text-sm text-gray-800 bg-transparent outline-none">
          </div>
          <div>
        ...
        <label id="lbl-midtrans" class="flex justify-between items-center border border-[#0D1F3C] rounded px-4 py-3.5 cursor-pointer mb-3">
        ...
        <label id="lbl-transfer" class="flex justify-between items-center border border-gray-200 rounded px-4 py-3.5 cursor-pointer mb-4">
          <div class="flex items-center gap-3">
      ...
      <div class="border border-gray-100 rounded p-6 lg:sticky lg:top-20">
        ...
        <div class="flex gap-3 items-center mb-4">
          <div class="relative flex-shrink-0">
            <img src="{{ $item['image'] }}" class="w-14 h-14 object-cover rounded" onerror="this.src='/IMAGE/SUPER.jpeg'">
