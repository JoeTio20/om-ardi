...
<header class="sticky top-0 z-50 bg-cream border-b border-gray-200">
  <div class="max-w-7xl mx-auto px-4 md:px-6 h-16 flex items-center justify-between">
    ...
    <div class="flex items-center gap-4">
      ...
      <a href="{{ route('home') }}" class="font-serif text-sm font-bold tracking-[.15em] uppercase">SARANG BURUNG</a>
    </div>
  ...
  <div id="mobile-menu" class="md:hidden bg-cream border-t border-gray-100 px-6 py-5">
    <nav class="flex flex-col gap-5">
      <a href="{{ route('home') }}" class="text-sm tracking-widest uppercase text-charcoal" onclick="document.getElementById('mobile-menu').classList.remove('open')">{{ __('messages.nav_home') }}</a>
      <a href="{{ route('philosophy') }}" class="text-sm tracking-widest uppercase text-charcoal" onclick="document.getElementById('mobile-menu').classList.remove('open')">{{ __('messages.nav_philosophy') }}</a>
      <a href="{{ route('product') }}" class="text-sm tracking-widest uppercase text-charcoal" onclick="document.getElementById('mobile-menu').classList.remove('open')">{{ __('messages.nav_product') }}</a>
      <hr class="border-gray-200">
      <a href="{{ route('lang.switch', app()->getLocale() === 'en' ? 'id' : 'en') }}" class="text-sm text-warm-gray">{{ app()->getLocale() === 'en' ? 'Ganti ke ID' : 'Switch to EN' }}</a>
    </nav>
  </div>
</header>
